                        ...
                        <section>
                            ...
                            <xsl:for-each select="hitos//hito">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        (
                                        <xsl:value-of select="./distancia/@unidades"/>
                                        )
                                    </li>
                                    <li>
                            ...
                            <aside>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 50">
                                    <polyline style="fill:white;stroke:#520496;stroke-width:1">
                                        <xsl:attribute name="points">
                                            <xsl:for-each select="hitos/hito/coordenadas">
                                                ...
                                                <xsl:value-of select="(20 * (position() - 1)) + 10"/>
                                                <xsl:text>,</xsl:text>
                                    ...
                                    <xsl:for-each select="hitos/hito/coordenadas">
                                        <text y="10" style="writing-mode: tb; glyph-orientation-vertical:0;background-color: black;font-size: 2px;">
